...
### 8.5 Безопасность и конфиденциальность
...
### 8.7 Качество кода и поддерживаемость
...
### 8.10 Ограничения и «вне объёма» ЛР-1
